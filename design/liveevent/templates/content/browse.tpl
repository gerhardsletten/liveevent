<strong class="title">
    {'Browse'|i18n( 'design/ezwebin/content/browse' )} - {$main_node.name|wash}
</strong>
...
<div class="buttonblock">
    ...
    {/if}
    <input class="defaultbutton" type="submit" name="SelectButton" value="{'Select'|i18n('design/ezwebin/content/browse')}" />
    {if $cancel_action}
